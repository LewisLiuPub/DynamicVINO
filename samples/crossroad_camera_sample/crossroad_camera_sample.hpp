...
static const char target_device_message[] = "Specify the target device for Person/Vehicle/Bike Detection (CPU, GPU, FPGA, MYRIAD, or HETERO). ";

/// @brief message for assigning Person attributes recognition inference to device
static const char target_device_message_person_attribs[] = "Specify the target device for Person Attributes Recognition (CPU, GPU, FPGA, MYRIAD, or HETERO). ";

/// @brief message for assigning Person Reidentification retail inference to device
static const char target_device_message_person_reid[] = "Specify the target device for Person Reidentification Retail (CPU, GPU, FPGA, MYRIAD, or HETERO). ";
...
static const char threshold_output_message[] = "Probability threshold for person/vehicle/bike crossroad detections.";

/// @brief message for probability threshold argument for person/vehicle/bike crossroad detections
static const char threshold_output_message_person_reid[] = "Cosine similarity threshold between two vectors for person reidentification.";
...
static void showUsage() {
    std::cout << std::endl;
    std::cout << "crossroad_camera_sample [OPTION]" << std::endl;
