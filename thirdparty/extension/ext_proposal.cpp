...
public:
    explicit ProposalImpl(const CNNLayer *layer): ExtLayerBase(layer) {
        try {
            ...
            box_coordinate_scale_ = cnnLayer.GetParamAsFloat("box_coordinate_scale", 1.0);
            box_size_scale_ = cnnLayer.GetParamAsFloat("box_size_scale", 1.0);
            ...
            std::string framework_ = cnnLayer.GetParamAsString("framework", "");
